...
starts the session should attach the project zip (~6 MB, ~27 MB with its git history; 67 scripts,
13500 lines; every code file inline in `version/CODE_SNAPSHOT.txt`).
