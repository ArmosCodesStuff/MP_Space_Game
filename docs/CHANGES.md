...
**Latest change:** the twelve classes and the six enemies (above).
...
- **The echo's explosion puff is host-only.** Its flashes and its damage reach guests; the
  `Explosion` node is added on the host's copy alone.
