...
**Latest change:** a won arena no longer sends you home on a 20 s clock -- each pilot presses a
**RETURN** button when done collecting, and the party warps home once every present pilot has (see
Unreleased).
