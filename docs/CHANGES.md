...
**Latest change:** two more tables underneath -- everything that flies (six rows, one flyer, one
launch on the wire) and everything that flashes (seven rows, seen by every peer) -- on top of the
twelve classes and the six enemies.
