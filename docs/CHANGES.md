...
**Latest change:** bigger ships, grey and white (above), on top of the owner's line art, the carrier's
deck, the escort's threat, boss sounds and damage numbers.
...
**Tests**: smoke **@@PASS@@**. Changed checks: every size above as literals (302.4, 35.1; 297.5; 227.5,
