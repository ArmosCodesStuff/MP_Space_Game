...
// Bands are listed lowest At first. A charge short of the lowest band fires as the lowest.
// Charges.All is reached by the weapon's ability id; a weapon with no table fires whole.
// ─────────────────────────────────────────────────────────────────────────────
...
{
    public static readonly Dictionary<string, ChargeBand[]> All = new()
    {
        ...
        ["railgun"] = new[] { new ChargeBand { At = 0, Mult = 1, Line = Lines.Rail } },
    };
