...
//                  will land, 1 s -- its nose 1090 u from its target; a big rock appears beside it and
...
// throw's backs off to 1090 u -- and between them closes on the party like any boss. The two never
...
public static class Drake
{
    public static readonly BossMove[] Moves =
    {
        ...
        // not a threat anyone can answer, so it warps its nose to 1090 u off first (1300 u from the
        // centre of the 420 u hull it was built on), on its own side of the pilot
        ...
        new() { Id = "throw", Way = MoveWay.Throw, Waits = MoveWait.Everything, Busy = true, Super = true,
                ...
                Warp = 1.0, Standoff = 1090f, WarpRing = 1.3f, WarpSound = "drake_warp",
