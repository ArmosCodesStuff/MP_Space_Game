...
public static class Plume
{
    ...
    public static void Draw(CanvasItem ci, Vector2 at, Vector2 back, float shipLength, Color col, float throttle)
    {
        float flick = 0.85f + 0.15f * Mathf.Sin(Time.GetTicksMsec() / 37f + at.X);
