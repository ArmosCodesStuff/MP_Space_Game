...
public static class Items
{
    ...
    private static readonly (string role, string[] ids)[] Roles =
    {
        ...
        ("@area",          new[] { "bubble_radius", "wave_range", "echo_radius", "whirl_reach", "hunter_range", "launch_range" }),
        ("@duration",      new[] { "bubble_time", "overdrive_time", "wave_disable", "stealth_time", "roll_time", "echo_time", "whirl_time", "prism_time", "anchor_time", "tether_hold" }),
    };
